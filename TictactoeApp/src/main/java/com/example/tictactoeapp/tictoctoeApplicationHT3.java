...
public class tictoctoeApplicationHT3 extends Application {
    ...
    private void playWinAnimation (Combo combo){
        Line line=new Line();
        line.setStartX(combo.titles[0].getCenterX());
        line.setStartY(combo.titles[0].getCenterY());
        line.setEndX(combo.titles[0].getCenterX());
        line.setEndY(combo.titles[0].getCenterY());

        root.getChildren().add(line);

        Timeline timeline = new Timeline();
        timeline.getKeyFrames().add(new KeyFrame(Duration.seconds(2),
                new KeyValue( line.endXProperty(), combo.titles[2].getCenterX()),
                new KeyValue(line.endYProperty(), combo.titles[2].getCenterY())));
        timeline.play();
    }
